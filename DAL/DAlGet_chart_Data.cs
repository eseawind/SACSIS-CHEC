...
namespace DAL
{
    public class DAlGet_chart_Data
    {
        ...
        public DataSet Get_ChartidByFuzzy_Query(string id, string[] para_id)
        {
            ...
            if (id == "T_BASE_PARAID_WIND")
            {
                ...
                //{
                sql = "select T_REALTIME,T_PARADESC from administrator.T_BASE_PARAID_WIND where T_LEVEL1='" + para_id[0] + "' and T_LEVEL2 ='" + para_id[1] + "' and T_LEVEL3='" + para_id[2] + "' and T_PARADESC like '" + para_id[3] + "'";
                //}
                //else
                //{
            ...
            {
                sql = "select T_REALTIME,T_PARADESC from administrator.T_BASE_PARAID_SUN where T_LEVEL1='" + para_id[0] + "' and T_LEVEL2 ='" + para_id[1] + "' and T_LEVEL3='" + para_id[2] + "' and T_PARADESC like '" + para_id[3] + "'";
            }
            DS = dl.RunDataSet(sql, out errMsg);
            return DS;
        }
  ...
  "FROM administrator.T_BASE_PARAID_SUN,(select  CHARTID from administrator.T_INFO_CHART_USERTEMPLATE  where CHARTID='" + chart_id + "') as a where REALTIME ='" + id + "'";
        ...
        {
            sql = "select T_PARAID,T_PARADESC,T_REALTIME from ADMINISTRATOR.T_BASE_PARAID_WIND where T_LEVEL3='" + id + "' and I_FLAG=" + flag;
        ...
        {
            sql = "select b.t_PARAID,b.T_PARADESC from ADMINISTRATOR.T_BASE_PARAID_WIND b inner join ADMINISTRATOR.T_BASE_FITTINGPARA f on b.T_PARAID=f.T_YID where f.T_XID='" + id + "'";
            return dl.RunDataTable(sql, out errMsg);
        }
    }
}
